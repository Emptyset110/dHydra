class CtpTdApi(TdApi):
    ...
    def onRspQryInvestorPosition(self, data, error, n, last):
        ...
        exchange = self.symbolExchangeDict.get(
            data['InstrumentID'], EXCHANGE_UNKNOWN)
    ...
    def onRspQryTradingAccount(self, data, error, n, last):
        ...
        account.balance = (
            data['PreBalance'] - data['PreCredit'] -
            data['PreMortgage'] + data['Mortgage'] -
            data['Withdraw'] + data['Deposit'] +
            data['CloseProfit'] + data['PositionProfit'] +
            data['CashIn'] - data['Commission']
        )
    ...
    def onRspQryInstrument(self, data, error, n, last):
        ...
        # '.'.join([contract.symbol, contract.exchange])
    ...
    def onRtnOrder(self, data):
        ...
        # '.'.join([order.symbol, order.exchange])
    ...
    def onRtnTrade(self, data):
        ...
        # '.'.join([trade.symbol, trade.exchange])
    ...
    def sendOrder(self, orderReq):
        ...
        # 非自动挂起
        req['IsAutoSuspend'] = 0
        req['TimeCondition'] = defineDict[
            'THOST_FTDC_TC_GFD']               # 今日有效
        req['VolumeCondition'] = defineDict[
            'THOST_FTDC_VC_AV']              # 任意成交量
        # 最小成交量为1
        req['MinVolume'] = 1
